...
namespace Demo
{
    ...
    {
        public static List<Product> ProductList { get; set; } // static
        public static List<Customer> CustomerList { get; set; } // from XML 
        static ListGenerator()
        {
            ProductList = new List<Product>()
            {
               new product02(){Id = 200},
                        new Product() {ProductID = 1, ProductName = "Chai", Category = "Meat/Poultry ",
                      ...
                      new Product{ ProductID = 3, ProductName = "Aniseed Syrup", Category = "Meat/Poultry ",
